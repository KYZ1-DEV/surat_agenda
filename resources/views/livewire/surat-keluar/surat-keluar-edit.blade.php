        ...
        <x-slot name="content">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <textarea wire:model="suratMasuk"  id="suratMasuk" readonly class="textarea textarea-bordered w-full"  required placeholder="Masukkan Nomor Surat"></textarea>
            ...
            <div>
                ...
                <textarea wire:model="form.keterangan" id="keterangan" class="textarea textarea-bordered w-full" placeholder="Masukkan Keterangan"></textarea>
